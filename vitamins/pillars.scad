...
// 두 판 사이 스탠드오프(standoff) — 양끝 암나사(female-female) M3 육각 필러.
// NopSCADlib M3 hex pillar는 수-암(top −8, bot +8)이라 한쪽이 수나사 스터드다.
// 두 판을 위·아래 스크류로 죄려면 양끝 암나사가 필요해 bot도 −8로 둔다.
...
M3x30_ff_hex_pillar = ["M3x30_ff_hex_pillar", "hex", 3, 30, 5 / cos(30), 5 / cos(30), 6, 6, "silver",  silver, -8,     -8,     true];
