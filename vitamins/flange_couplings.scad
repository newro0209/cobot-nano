// vitamins/flange_couplings.scad - Local flange coupling family, not present in NopSCADlib.
// A flange coupling clamps onto a round shaft through a central hub (grub screw) and presents a round flange with a
...
module FC(type) { //! Draw a flange coupling, flange in XY (z = 0 face mounts down), bore up the Z axis
    vitamin(str("FC(", type[0], "): ", fc_bore(type), "mm flange coupling"));
