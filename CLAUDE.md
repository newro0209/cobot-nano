...
# OpenSCAD에서 assemblies/robot_assembly.scad 열어 미리보기 (bc/ac/ua_exploded 슬라이더로 분해)

# 헤드리스 컴파일 검증 (경고 0 확인; NopSCADlib 내부 2p54 deprecation은 무시)
"/c/Program Files/OpenSCAD/openscad.exe" -o /tmp/out.echo assemblies/robot_assembly.scad
```
